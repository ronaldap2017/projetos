...
public class DAOPedido {
	...
	public void excluirv (Pedido v) throws Exception
	{
		Session sessao = fabrica.openSession();
		Transaction transacao = sessao.beginTransaction();
		String sql = "delete from pedido where codigo_pedido = "+v.getNotafiscal();
	...
	public void excluirpg (Pedido pg) throws Exception
	{
	Session sessao = fabrica.openSession();
	Transaction transacao = sessao.beginTransaction();
	String sql = "delete from Pagamento where pedido_codigo_pedido = "+pg.getNotafiscal();
	Query q = sessao.createQuery(sql);
	q.executeUpdate();
	transacao.commit();
	sessao.flush();
	...
	public int consultarparcelas(Pedido parc)throws Exception
	{
		
		Session sessao = fabrica.openSession();
		Transaction transacao = sessao.beginTransaction();
		
		String sql = "select count(*) from Pagamento where pedido_codigo_pedido = "+parc.getNotafiscal();
		Object q = sessao.createQuery(sql).uniqueResult();
		String qtd = String.valueOf(q);
		int parcelas = Integer.parseInt(qtd);
//		q.executeUpdate();
		transacao.commit();
		sessao.flush();
		sessao.close();
